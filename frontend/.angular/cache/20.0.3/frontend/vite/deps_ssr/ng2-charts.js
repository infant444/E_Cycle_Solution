...
var _ThemeService = class _ThemeService {
  constructor() {
    this.colorschemesOptions = new import_rxjs.BehaviorSubject(void 0);
  }
...
var _BaseChartDirective = class _BaseChartDirective {
  constructor(element, zone, themeService) {
    ...
    this.subs.push(this.themeService.colorschemesOptions.pipe((0, import_operators.distinctUntilChanged)()).subscribe((r) => this.themeChanged(r)));
  }
  ngOnChanges(changes) {
...
var _NgChartsConfiguration = class _NgChartsConfiguration {
  constructor() {
...
_NgChartsConfiguration.ɵprov = ɵɵdefineInjectable({
  token: _NgChartsConfiguration,
  factory: _NgChartsConfiguration.ɵfac,
  providedIn: "root"
});
var NgChartsConfiguration = _NgChartsConfiguration;
(() => {
...
var _NgChartsModule = class _NgChartsModule {
  constructor(config) {
...
_NgChartsModule.ɵmod = ɵɵdefineNgModule({
  type: _NgChartsModule,
  declarations: [BaseChartDirective],
  exports: [BaseChartDirective]
});
_NgChartsModule.ɵinj = ɵɵdefineInjector({});
var NgChartsModule = _NgChartsModule;
(() => {
